    ...
    `
            ...
            <tbody>
              ...
              {state.YearBuilt && state.YearBuilt.length > 0 ? (
                <tr key="YearBuilt">
                  ...
                  {state.YearBuiltSource && state.YearBuiltSource.length > 0 ? (
                    <tr key="YearBuiltSource">
              ...
              {state.MLSPIN_MANAGEMENT && state.MLSPIN_MANAGEMENT.length > 0 ? (
              ...
              {state.MLSPIN_LEAD_PAINT && state.MLSPIN_LEAD_PAINT.length > 0 ? (
      ...
      <div className={styles["single-prop-map"]}>
        <GoogleMapReact
          ...
          options={options}
        >
          <Marker lat={state.Latitude} lng={state.Longitude} text="My Marker" />
        </GoogleMapReact>
      </div>
      <hr />
